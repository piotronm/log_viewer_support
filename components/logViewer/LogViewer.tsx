  ...
  return (
    <div id='top'>
      ...
      <div className='top-row'>
        ...
        <a className="support-portal" href="https://www.google.com" target=".blank" rel="noopener noreferrer">Support Portal </a>
      </div>
      ...
      <div id='bottom'>
        ...
        <button className='top-of-page' onClick={handleAboutClick}>Top of Page</button>
          <button className='bottom-of-page' onClick={handleContactClick}>Bottom of Page</button>
        </div>
      </div>
  </div>
  );    
