  ...
  return (
    <div id='top'>
      ...
      <div className='top-row'>
        ...
        <button className='log-viewer-button' onClick={handleExport}>Export</button>
        <button className='log-viewer-button'onClick={() => window.location.reload()}>Clear Log File</button>
        <button className='log-viewer-button' onClick={resetFilters}>Reset Filters</button>
        <input type="text" className="search-input" value={searchTerm} onChange={handleSearchInput} placeholder='Search' />
        <button className='log-viewer-button' onClick={toggleSortOrder}>Currently Displaying {sortOrder === "newest" ? "Oldest - Newest" : "Newest - Oldest"}</button>
        <Link to="/" className="support-portal">Support Portal</Link>
      </div>
      ...
      <div id='bottom'>
        ...
        <button className='log-viewer-button' onClick={handleAboutClick}>Top of Page</button>
          <button className='log-viewer-button' onClick={handleContactClick}>Bottom of Page</button>
        </div>
      </div>
  </div>
  );    
